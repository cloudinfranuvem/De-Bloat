...
'@
    ...
    if ($nonAdminLoggedOn -eq $false) {
        ...
        $starturl = "https://github.com/cloudinfranuvem/De-Bloat/raw/main/De-Bloat/start2.bin"
...
if ($manufacturer -like "*HP*") {
    ...
    if (test-path -Path 'C:\Program Files (x86)\InstallShield Installation Information\{6468C4A5-E47E-405F-B675-A70A70983EA6}\setup.exe') {
        invoke-webrequest -uri "https://raw.githubusercontent.com/cloudinfranuvem/De-Bloat/main/De-Bloat/HPConnOpt.iss" -outfile "C:\Windows\Temp\HPConnOpt.iss"
...
if ($mcafeeinstalled -eq "true") {
    ...
    # Download Source
    $URL = 'https://github.com/cloudinfranuvem/De-Bloat/raw/main/De-Bloat/mccleanup.zip'
...
##Download the ODT
$odturl = "https://github.com/cloudinfranuvem/De-Bloat/raw/main/De-Bloat/odt.exe"
